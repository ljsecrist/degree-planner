...
/**
 * The PDFParser class processes a PDF transcript file to extract course information,
 * reorders and filters the text, and constructs an Excel sheet from the parsed data.
 */
public class PDFParser {

    // Magic number constant for splitting columns
    ...
    /**
     * Main method to run the PDFParser independently.
     *
    ...
    /**
     * Processes a PDF file to extract transcript data, reorders and filters the text,
     * associates course types, and constructs an Excel sheet from the parsed lines.
     *
    ...
    /**
     * Reorders the text columns from the PDF by splitting each line at a fixed index.
     *
     * @param text the full text extracted from the PDF
     * @param firstColumn the list to store the first column lines
     * @param secondColumn the list to store the second column lines
     */
    public static void reorderColumns(String text, List<String> firstColumn, List<String> secondColumn) {
        String[] lines = text.split("\n");

        for (String line : lines) {
            if (line.length() > COLUMN_SPLIT_INDEX) {  // Split at character index 69
    ...
    /**
     * Filters a list of lines, keeping only those that match course lines, term headers, or course types.
     *
     * @param lines the list of lines to filter
     * @return a list of lines that are considered necessary
     */
    ...
    /**
     * Associates standalone course type lines with their preceding course lines.
     *
     * @param lines the list of lines to process
     * @return a list of structured lines where course types are appended to the corresponding course line
     */
    ...
    /**
     * Prints formatted course details from a list of lines.
     *
     * @param lines the list of formatted lines representing courses
     */
    ...
    /**
     * Constructs an Excel sheet from a list of parsed lines and writes it to a file.
     *
    ...
    /**
     * Converts a term header string to a term code in the format "YY/TC".
     *
     * @param termHeader the term header string
     * @return the converted term code
     */
    ...
    /**
     * Checks if a line matches the course line pattern.
     *
     * @param line the line to check
     * @return true if the line is a course line, false otherwise
     */
    ...
    /**
     * Checks if a line matches the term header pattern.
     *
     * @param line the line to check
     * @return true if the line is a term header, false otherwise
     */
    ...
    /**
     * Checks if a line matches the course type pattern.
     *
     * @param line the line to check
     * @return true if the line is a course type, false otherwise
     */
